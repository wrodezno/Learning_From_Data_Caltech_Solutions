...
for q in degree:
    for i in range(len(C)):
        SolutionA = svm.SVC(C = C[i],kernel = kernel,degree=q,
    ...
    #Results for the different polynomials
    DegPolyEout[q] = ListEout
    DegPolyEin[q] = ListEin
    DegPloySVs[q] = Num_SupportVectors 
